...
const ASSETS = ['./', './index.html', './styles.css?v=33', './app.js?v=45', './brand.js?v=35', './calendar-layout.js?v=25', './range-entries.js?v=28', './calendar-connections.js?v=37', './navigation-controls.js?v=37', './ui-preferences.js?v=21', './manifest.json?v=35', './ninq-logo.svg?v=34', './icon-192.png?v=34', './icon-512.png?v=34', './apple-touch-icon.png?v=34'];
