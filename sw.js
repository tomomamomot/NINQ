...
const ASSETS = ['./', './index.html', './styles.css?v=78', './app.js?v=114', './firebase-sync.js?v=2', './brand.js?v=35', './calendar-layout.js?v=28', './range-entries.js?v=28', './calendar-connections.js?v=51', './navigation-controls.js?v=38', './settings-polish.js?v=1', './manifest.json?v=35', './ninq-logo.svg?v=34', './ninq-wordmark.svg?v=2', './icon-192.png?v=34', './icon-512.png?v=34', './apple-touch-icon.png?v=34'];
